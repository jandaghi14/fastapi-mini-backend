...
def test_admin_get_other_user_all_todos_not_found_user(client, auth_header):
...
def test_admin_get_other_user_all_todos_no_todos(client, auth_header, create_user):
...
def test_admin_get_other_user_all_todos_non_admin_user(client, create_user, create_a_todo, only_get_token):
    ...
    role = 'user'
    create_user(username=user2_username, password=user2_password, role=role)
...
def test_admin_can_see_soft_deleted_todos(client, auth_header, create_user, create_a_todo, only_get_token):
    ...
    assert response.status_code == 200
    assert len(response.json()) == 2
    assert response.json()[1]['is_deleted'] is True
...
def test_admin_get_other_user_single_todo_success(client, auth_header, create_user, create_a_todo, only_get_token):
    ...
    user_password = 'randompass'
    role = 'user'
    create_user(username=user_username, password=user_password, role=role)
...
def test_admin_get_other_user_single_todo_not_found_todo(
        client, auth_header, create_user, create_a_todo, only_get_token):
...
def test_admin_get_other_user_single_todo_non_admin_user(
        client, auth_header, create_user, create_a_todo, only_get_token):
...
def test_admin_update_todo_success(client, auth_header, create_user, create_a_todo, only_get_token):
    ...
    assert response.json()['is_deleted']
...
# ---------------------------------------------------------------------------------------------
def test_admin_get_other_user_all_todos_with_owner_name_success(
        client, auth_header, create_user, create_a_todo, only_get_token):
